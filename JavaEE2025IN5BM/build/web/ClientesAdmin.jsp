        ...
        <section class="top-container">
            <div class="formulario">
                ...
                <form>
                    ...
                    <input type="text" id="txtCodigoCliente" placeholder="Ej: 101" />

                    <label for="nombreCliente">Nombre</label>
                    <input type="text" id="txtNombreCliente" placeholder="Nombre completo" />

                    <label for="telefonoCliente">Teléfono</label>
                    <input type="text" id="txtTelefonoCliente" placeholder="59677843" maxlength="8" />

                    <label for="correoCliente">Correo</label>
                    <input type="email" id="txtCorreoCliente" placeholder="cliente@correo.com" />

                    <label for="direccionCliente">Dirección</label>
                    <input type="text" id="txtDireccionCliente" placeholder="Dirección del cliente" />
                    
                    <label for="direccionCliente">Contraseña</label>
                    <input type="text" id="txtContraseñaCliente" placeholder="Contraseña del cliente" />
